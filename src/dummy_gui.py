...
from files_generator import DummyGenerator

# --------------------------------- #
LOGGER = logging.getLogger('dummy_gui')
...
class MainCore(ttk.Frame):
    ...
    def __init__(self, parent, *args, **kwargs):
        ...
        self.status = ttk.Label(self.options_label,
    ...
    def generate_dummy(self):
        ...
        LOGGER.warning('self.toggle_invisible: %s', self.toggle_invisible)
